	...
	<div class="row">
		<div class="panel panel-primary">
		    ...
		    <table class="table table-striped table-hover">
		      ...
		      <tbody>
							<%while (rs.next()) { %>
							<form action="udelete.jsp" method="get">
							<tr>
								<td><input type="hidden" name="UID" value=<%=rs.getString("u_id") %>><%=rs.getString("u_id")%></td>
								
								<td><%=rs.getString("uname")%></td>
								<td><%=rs.getString("uphone")%></td>
								<td><%=rs.getString("u_mail")%></td>
								<td><%=rs.getString("uid_n")%></td>
								<td><input type="submit" class='btn btn-info btn-xs' value="삭제하기"></td>
							</tr>
							</form>
							<%
			}
