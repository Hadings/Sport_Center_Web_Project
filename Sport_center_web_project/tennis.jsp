			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="./Resources/images/PT01.jpg" style="width: 100%;"
							alt="image_2">
					</div>
					<div class="item">
						<img src="./Resources/images/PT02.jpg" style="width: 100%;"
							,alt="image_2">
					</div>
...
<div class="container">
  ...
  String query = "select * from p_schedule natural join  programm join teacher on teacher.tno = programm.tno where pno like 'PT%'";
