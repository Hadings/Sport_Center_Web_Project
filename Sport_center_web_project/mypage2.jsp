...
<body>
	...
	<div class="container">
		...
		<!--  using sql -->
			...
			Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", DB_USER,
					DB_PASSWARD);

			String query = "select * from p_schedule natural join programm natural join p_rev natural join facility where p_rev.U_ID = '"+userID+"'";
			...
			<div class="width=100%">
				<table class="table table-striped custab">
					...
					<tr>
						...
						<td class="text-center" onclick="pdelete()"><a class='btn btn-info btn-xs' href="#"><span class="glyphicon glyphicon-edit"></span> 삭제 </a></td>
						<script>
						function pdelete(){
							document.location.href = "pro_delete.jsp";
						}
						</script>
					</tr>
