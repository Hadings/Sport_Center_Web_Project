...
<body>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="./Resources/images/PG01.jpg" style="width: 100%;"
							alt="image_2">
					</div>
					<div class="item">
						<img src="./Resources/images/PG02.jpg" style="width: 100%;"
							,alt="image_2">
					</div>
					<div class="item">
						<img src="./Resources/images/PG03.jpg" style="width: 100%;"
							,alt="image_2">
					</div>
	...
	<div class="container">
		...
		<%
			...
			String DB_URL = "jdbc:oracle:thin:@db.pknu.ac.kr:1521:xe";
			String DB_USER = "db201211796";
			String DB_PASSWARD = "201211796";
			Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@db.pknu.ac.kr:1521:xe", DB_USER,
					DB_PASSWARD);
			
			String query = "select * from facility natural join f_schedule where fno like 'F4%'";
